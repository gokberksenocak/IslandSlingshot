...
public class PlayerManager : MonoBehaviour
{
    ...
    [SerializeField] private BallTakeAni _ballTakeAni;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.transform.DOMoveY(other.transform.position.y - 5f, 1.5f);
        ...
        else if (other.CompareTag("Finish"))
        {
            if (_collectedBalls.Count == 0)
            {
                ...
                _uiManager.LoosePanel.transform.DOMove(_uiManager.ExamplePanel.transform.position, 1.25f).OnComplete(() =>
                {
        ...
        else if (other.CompareTag("Ball"))
        {
            ...
            _ballTakeAni.BallUIAnimation(other.gameObject);
    ...
    IEnumerator ReachToSling()
    {
        ...
        {
            _uiManager.SlingTutorialPanel.SetActive(true);
            Time.timeScale = 0;
        }
    }
    public void CloseToSlingTutorial()
    {
        Time.timeScale = 1;
        _uiManager.SlingTutorialPanel.SetActive(false);
    }
    void MagnetTimeUp()
    {
